...
export const wallpaperPresets: WallpaperPreset[] = [
  ...
  // ===== TEXTURES & PATTERNS (CSS-only) =====
  {
    ...
    name: 'Mesh warm',
    css: [
      'radial-gradient(at 40% 20%, #3d8b9e22 0px, transparent 50%)',
      'radial-gradient(at 80% 0%, #b08d6a22 0px, transparent 50%)',
      'radial-gradient(at 0% 50%, #5ea3b422 0px, transparent 50%)',
      'radial-gradient(at 80% 50%, #8a7aaa22 0px, transparent 50%)',
      'radial-gradient(at 0% 100%, #89bfcc22 0px, transparent 50%)',
